...
const FORMULES: readonly Formule[] = [
  ...
  },
  {
    ...
    specs: [
      ...
      { k: 'Format', v: 'Auberges et bivouacs — temps fort : la Boucle Sud, 7 jours et plus de 1 500 km' },
    ],
  },
  {
    ...
    specs: [
      ...
      { k: 'Format', v: 'Road-book sur mesure et briefing quotidien. Références : L’Oréal, Renault, Bardahl' },
    ],
  },
  {
...
export function Formules() {
  ...
  return (
    <ul
      className="grid list-none grid-cols-1 gap-5 sm:grid-cols-2 md:gap-6 lg:grid-cols-4 lg:gap-4"
    ...
    >
      {FORMULES.map((f, i) => {
        ...
        return (
          <li key={f.href} className="relative">
            <Link
              to={f.href}
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                <dl className="mt-6 flex-1 border-t border-line pt-4 text-sm">
                  {f.specs.map((spec) => (
                    <div key={spec.k} className="border-b border-line/60 py-3 last:border-0 last:pb-0">
