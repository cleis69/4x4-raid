 ...
 *
 *  ⚠️ `ogImage` pointe volontairement vers un fichier .jpg et non vers
 *  le WebP servi aux navigateurs : plusieurs robots de réseaux sociaux
 *  ne décodent pas le WebP et afficheraient une carte vide. Chaque clé
 *  citée ici porte `ogJpeg` dans `medias.ts`.
 * ─────────────────────────────────────────────────────────────────
 */
...
export const SEO = {
  home: {
    ...
    ogImage: '/media/dunes-lever-soleil.jpg',
  },
  circuits: {
    ...
    ogImage: '/media/piste-coucher-soleil.jpg',
  },
  surMesure: {
    ...
    ogImage: '/media/dunes-ciel-bleu.jpg',
  },
  entreprises: {
    ...
    ogImage: '/media/convoi-atlas-enneige.jpg',
  },
  marrakech: {
    ...
    ogImage: '/media/dune-descente.jpg',
  },
  excursions: {
    ...
    ogImage: '/media/village-berbere-piste.jpg',
  },
  guide: {
    ...
    ogImage: '/media/equipe-briefing-plateau.jpg',
  },
  decouvrir: {
  ...
  actualite: {
    ...
    ogImage: '/media/bivouac-dunes-crepuscule.jpg',
  },
  photos: {
  ...
  temoignages: {
    ...
    ogImage: '/media/erg-vue-plongeante.jpg',
  },
  partenaires: {
    path: '/partenaires/',
    ...
    ogImage: '/media/oasis-palmeraie.jpg',
  },
  contact: {
    path: '/contact/',
    ...
    ogImage: '/media/oued-traversee.jpg',
  },
